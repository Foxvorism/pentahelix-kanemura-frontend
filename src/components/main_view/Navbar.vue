...
<!-- <template>
  <div
    id="navbar"
    class="w-full h-24 bg-[var(--color-cream)] flex items-center fixed z-50"
  >
  ...
  <header id="header" class="fixed w-screen">
    ...
    >
      ...
      <nav id="navbar" class="navbar">
        ...
        <i
          class="ph-bold ph-list mobile-nav-toggle font-black text-2xl"
          @click="toggle_mobile"
        />
      </nav>
    </div>
